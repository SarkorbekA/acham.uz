...
urlpatterns = [
    ...
    path('third_page/<int:pk>', third_page, name='third_page'),
    ...
    path('second_page_en/', second_page_en, name='second_page_en'),
    path('third_page_en/<int:pk>', third_page_en, name='third_page_en'),
    path('fourth_page_en/', fourth_page_en, name='fourth_page_en'),
    path('search_en/', search_collections_en, name='search_collections_en'),


    # uz
    path('index_uz', index_uz, name='index_uz'),
    path('second_page_uz/', second_page_uz, name='second_page_uz'),
    path('third_page_uz/<int:pk>', third_page_uz, name='third_page_uz'),
    path('fourth_page_uz/', fourth_page_uz, name='fourth_page_uz'),
